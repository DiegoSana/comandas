...
class AplicacionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Aplicacion']))
		{
			...
			if($model->save()) {
                                Yii::app()->user->setFlash('success', "La aplicación \"".$model->nombre."\" se ha creado correctamente!");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Aplicacion']))
		{
			$model->attributes=$_POST['Aplicacion'];
			if($model->save()) {
                                Yii::app()->user->setFlash('success', "La aplicación \"".$model->nombre."\" se ha modificado correctamente!");
				$this->redirect(array('view','id'=>$model->id));
                        }
		}
	...
	{
            $this->redirect('/aplicacion/admin');
	}
