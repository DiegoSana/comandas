...
class WSFE {
  ...
  const WSDL = "wsdl/wsfev1.wsdl";                   # The WSDL corresponding to WSFE
  const CERT = "keys/pedido.crt";                # The X.509 certificate in PEM format
  const PRIVATEKEY = "keys/privada.key";          # The private key correspoding to CERT (PEM)
